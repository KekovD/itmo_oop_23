...
public static class AccountWithdrawalUnsuccessful
{
    ...
    [Theory]
    [MemberData(nameof(GetRequest), MemberType = typeof(AccountWithdrawalUnsuccessful))]
    private static void ConditionCheck(IList<object> requests)
    {
        ...
        Assert.True(customer.Balance == 20);
    }
}